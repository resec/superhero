...
.provider('getFile', ['app',
    function (app) {
        this.html = function (fileName) {
            return '/static/template/' + fileName + '?v=' + app.version;
        };
...
.config(['$routeProvider', '$locationProvider',
    ...
    function ($routeProvider, $locationProvider) {
        var main = {
            ...
            edit = {
                templateUrl: 'static/template/article-editor.html',
            ...
            reset = {
                templateUrl: 'static/template/reset.html',
            ...
            article = {
                templateUrl: 'static/template/article.html',
                controller: 'articleCtrl'
            },
            collection = {
                templateUrl: 'static/template/collection.html',
...
.factory('restAPI', ['$resource',
    function ($resource) {
        return {
            index: $resource('/index/:OP'),
            user: $resource('/user/:ID/:OP'),
            article: $resource('/article/:ID/:OP'),
            tag: $resource('/tag/:ID/:OP')
        };
    }
])
...
.directive('genPagination', function () {
    ...
    return {
        scope: true,
        templateUrl: 'static/template/gen-pagination.html',
        link: function (scope, element, attr) {
...
.directive('genModal', ['$timeout',
    function ($timeout) {
        ...
        return {
            scope: true,
            transclude: true,
            templateUrl: 'static/template/gen-modal.html',
            link: function (scope, element, attr) {
                var modalStatus,
...
.directive('genUploader', ['$fileUploader', 'app',
    function ($fileUploader, app) {
        ...
        return {
            scope: true,
            templateUrl: 'static/template/gen-uploader.html',
            link: function (scope, element, attr) {
...
jsGen
.controller('mainCtrl', ['app', '$scope', '$routeParams', 'getList',
    function (app, $scope, $routeParams, getList) {
        ...
        $scope.parent = {
            getTpl: 'static/template/main-article.html',
            viewPath: 'latest',
...
.controller('tagCtrl', ['app', '$scope', '$routeParams', 'getList',
    function (app, $scope, $routeParams, getList) {
        ...
        $scope.parent = {
            getTpl: 'static/template/main-tag.html'
        };
        $scope.pagination = {};
